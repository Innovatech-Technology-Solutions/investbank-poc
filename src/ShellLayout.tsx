        ...
        <div className='flex content-between flex-wrap lg:flex-nowrap lg:justify-between lg:items-center'>
            ...
            <div className="menu-main-menu-container">
               ...
               <li className="menu-item lg:inline-flex lg:items-center has-link-icon">
                                 <Link to='/udp/services' className="hover:!text-primary-800 hover:!border-primary-800">
               ...
               <li className="menu-item lg:inline-flex lg:items-center"> <Link to="/udp/szhp/housing-dashboard" className="hover:!text-primary-800 hover:!border-primary-800">{"Dashboard"}</Link> </li>
                  <li className="menu-item lg:inline-flex lg:items-center"> <Link to="/udp/szhp/my-applications" className="hover:!text-primary-800 hover:!border-primary-800">{'My Applications'}</Link> </li>
